 ...
 if (teks == 'edukasi') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛 Info Bot`, rowId: ".botinfo", description: "✧ info DamzzBotz"},
	    {title: `💌 Owner`, rowId: ".owner", description: "✧ Developer"},
	...
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 DanzzBotz.."},
	]
    },{
